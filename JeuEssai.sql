...
INSERT INTO `activite` (`id`, `labelle`)
VALUES (3, 'Non Renseigné'),
       (4, 'Agence Web'),
...
INSERT INTO `entreprise` (`id`, `activite_id`, `nom`, `rue`, `ville`, `pays`, `cp`, `num_rue`)
VALUES (8, 8, 'Association Le Pré de la Bataille', 'rue du pré de la bataille', 'Rouen', 'France', '76000', '39'),
       ...
       (11, 9, 'ANOXA (METALLERIE NORMANDE ) / YESKA Group', 'Rue de la coulée verte', 'Val-de-Reuil', 'France',
        '27400', '0'),
       ...
       (34, 3, 'Marie de Franquiville Saint Pierre', 'rue de la République', 'Franqueville Saint Pierre', 'France',
        '76520', '331'),
       (35, 3, 'MSA Haute Normandie', 'Cité de l\'agriculture chemin de la Bretèque', 'Bois Guillaume', 'France',
        '76230', '0'),
       (36, 3, 'N-CyP', 'Odyssée F – Avenue de Cambridge HEROUVILLE SAINT CLAIR Ou ou 82 Avenue de Thiès', 'CAEN',
        'France', '76000', '4'),
       ...
       (44, 3, 'SGA Mobility ou industries', 'Rue Jean philippe Rameau B6 Pôle Delta', 'Rouen', 'France', '76000',
        '27'),
       ...
       (48, 3, 'Toshiba TEC Europe Imaging Systems', 'Rue Louis Berliot Neuville Les Dieppe', 'Dieppe', 'France',
        '76000', '0'),
       (49, 11, 'TOTAL ENERGIES', 'Voie industrielle', 'Gonfreville L’Orcher', 'France', '76700', '0'),
       (50, 12, 'TRANSDEV (Ex TCAR)', 'rue de la Petite Chartreuse CS 60099 76 002 ROUEN Cedex 1', 'ROUEN', 'France',
        '76002', '15'),
...
INSERT INTO `professionelle` (`id`, `nom`, `prenom`, `email`, `num_tel`, `metier`)
VALUES (43, 'JOURDAN', 'Sophie', 'sjourdan@3ddentalstore.fr', '0230322403', 'DRH'),
       ...
       (55, 'ALVES', 'David', 'david.alves@carsat-normandie.fr', '0235036059',
        'Tuteur Responsable Adjoint Informatique Régionale'),
       ...
       (58, 'LE DENMAT', 'Jean-Marc', 'jean-marc.le-denmat@chb.unicancer.fr', '0232082209',
       ...
       (71, 'DALMONT', 'Jean marc', 'jean_marc.dalmont@dgfip.finances.gouv.fr', '0622353750',
       ...
       (80, 'VATELIER', 'Catherine', 'catherine.vatelier@darnetal.fr', '0235082937',
       ...
       (83, 'GOULAY', 'Christophe', 'info.tel@franquevillesaintpierre.com', '0235802039',
        'Resp info et téléphonie informatique'),
       (84, 'HICHOUR', 'Khalid', 'hichour@khalid@hautenormandie.msa.fr', '0232987240', 'Responsable Informatique'),
       (85, 'FELIX', 'Emmanuelle', 'emmanuelle.felix@totalenergies.com', '0235116062',
        'Adjointe département maintenance'),
       ...
       (96, 'FELIX', 'Emmanuelle', 'emmanuelle.felix@totalenergies.com', '0235116062',
        'Adjointe département maintenance'),
...
INSERT INTO `specialisation` (`id`, `labelle`)
VALUES (3, '1SIO SLAM'),
       (4, '2SIO SLAM'),
       (5, '1SIO SISR'),
       (6, '2SIO SISR'),
...
INSERT INTO `etudiant_stage` (`etudiant_id`, `stage_id`)
VALUES (1, 1),
       (2, 2),
       (3, 2),
       (4, 3),
...
INSERT INTO `professionelle_stage` (`professionelle_id`, `stage_id`)
VALUES (45, 1),
       (45, 2),
       (46, 3),
       (47, 3),
...
INSERT INTO `specialisation_entreprise` (`specialisation_id`, `entreprise_id`)
VALUES (3, 9),
       (3, 11),
       (3, 12),
       (3, 15),
...
INSERT INTO `jury_professionelle` (`jury_id`, `professionelle_id`)
VALUES (1, 44),
       (1, 50),
       (1, 52),
       (1, 56),
...
INSERT INTO `utilisateur` (`id`, `role_id`, `username`, `password`, `email`)
VALUES (1, 1, 'admin', '$2y$10$FeDWfRDrhdStJ6i0KCxSSurYtlKOtaaOmPchtkyDt/DvhLbV1oVm6', 'admin@localhost'),
